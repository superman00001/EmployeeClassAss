...
namespace Employee
{
    class Program
    {
        ...
        {
            Employee empl1 = new Employee("Ishola", "Wale", (decimal)800000.50);
            Employee empl2 = new Employee("ayomide", "Odunayo", (decimal)400000.25);
            ...
            empl1.Salary = empl1.Salary * (decimal)0.1;
            empl2.Salary = empl2.Salary * (decimal)0.1;
